...
import 'package:si_bestie/feature/gemini/repository/base_gemini_repository.dart';
...
Give answer in a friendly tone with being crisp and precise in your answer in Bahasa Indonesian. DONOT use any buzzwords, make sure your language is simple and easy to understand. 
...
To ensure continuity, you should create the quiz in Indonesian but the answer structure is in English as I will provide, even if the text provided does not contain pre-existing questions and answers. If the text contains questions and answers then insert them into the quiz. If not, then you will create questions and answers based on the text provided. Avoid making the same questions and try to have only one correct answer option, please make the quiz different from the previous one.
